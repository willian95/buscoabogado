...
@section("content")
    ...
    <div class="d-flex flex-column-fluid" id="dev-lawyer-list">
        <!--begin::Container-->
        <div class="container">
            <!--begin::Card-->
                        ...
                        <table class="table">
                            <thead>
                                <tr >
                                    ...
                                    <th class="datatable-cell datatable-cell-sort">
                                        <span style="width: 250px;">RUT</span>
                                    </th>
                                    ...
                                    <th class="datatable-cell datatable-cell-sort">
                                        <span style="width: 250px;">Especialidad</span>
                                    </th>

                                    <th class="datatable-cell datatable-cell-sort">
                                        <span style="width: 130px;">Fecha de egreso</span>
                                    </th>
                                    <th class="datatable-cell datatable-cell-sort">
                            ...
                            <tbody>
                                <tr v-for="lawyer in lawyers">
                                    ...
                                    <td>
                                        <button class="btn btn-secondary" @click="erase(lawyer.id)"><i class="far fa-trash-alt"></i></button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
        ...
        const app = new Vue({
            ...
            methods:{
                ...
                fetch(page = 1){
                    ...
                    axios.get("{{ url('/lawyers/fetch/') }}"+"/"+page)
                    .then(res => {

                        this.lawyers = res.data.lawyers
                        this.pages = Math.ceil(res.data.lawyersCount / res.data.dataAmount)
                ...
                erase(id){
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            this.loading = true
                            axios.post("{{ url('/lawyers/delete/') }}", {id: id}).then(res => {
                                this.loading = false
