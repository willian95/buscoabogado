...
@section("content")
    ...
    <div class="d-flex flex-column-fluid" id="dev-dicom-list">
        <!--begin::Container-->
        <div class="container">
            <!--begin::Card-->
        ...
        const app = new Vue({
            ...
            methods:{
                ...
                fetch(page = 1){
                    ...
                    axios.get("{{ url('/dicom/fetch/') }}"+"/"+page)
                    .then(res => {

                        this.payments = res.data.payments
                        this.pages = Math.ceil(res.data.paymentsCount / res.data.dataAmount)
